...
class App extends React.Component {
    ...
    render(){
        return( 
                ...
                {this.state.housingType && this.state.housingType !== 'renter' 
                    && <Solar parentCallback = {this.handleAppState} />}

                {this.state.housingType && (this.state.housingType == 'renter' 
                    || (this.state.housingType == 'homeowner' && 
                    this.state.solar)) && <HomeProds parentCallback = 
                    {this.handleAppState} currentStatus = {this.state}/>}

                {this.state.solar && this.state.housingType && 
                    this.state.housingType !== 'renter' && this.state.housingType 
